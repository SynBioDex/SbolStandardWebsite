...
<ul><li> New glyphs are added for introns and polypeptide regions (e.g., protein domains). </li>
<ul><li> The macromolecule glyph often confused with yeast is deprecated, and a new glyph for proteins added </li>
<ul><li> Small polygons are recommended as alternative glyphs for simple chemicals. </li></ul>| Specification  |   |
| **2.1.0**
