...
<details>
  ...
  You can get the SBOL logo {{% staticref "img/SBOLlogo.png" "newtab" %}}here{{% /staticref %}}.

  You can get the SBOL Visual logo {{% staticref "img/SBOLVisualLogo.png" "newtab" %}}here{{% /staticref %}}.

  You can get the SBOL Industrial Consortium logo {{% staticref "img/industrial/SBOLIndustrialLogo.png" "newtab" %}}here{{% /staticref %}}.
