...
<details>
  ...
  You can get the SBOL logo {{% staticref "img/Logos/SBOLlogo.png" "newtab" %}}here{{% /staticref %}}.

  You can get the SBOL Visual logo {{% staticref "img/Logos/SBOLVisualLogo.png" "newtab" %}}here{{% /staticref %}}.

  You can get the SBOL Industrial Consortium logo {{% staticref "img/Logos/SBOLIndustrialLogo.png" "newtab" %}}here{{% /staticref %}}.
