...
|---|---|---|
| **3.0.1** <br> An updated version of SBOL 3.0.0 data model to refine naming conventions, and add the hasNamespace property to a TopLevel object.| {{% staticref "docs/SBOL3.0.1specification.pdf" "newtab" %}}Specification{{% /staticref %}}  |  |
