...
<details>
  ...
  You can get the SBOL logo {{% staticref "static\media\Logos\SBOLlogo.png" "newtab" %}}PNG image file{{% /staticref %}} or {{% staticref "img/Logos/SBOLlogo.svg" "newtab" %}}SVG image file{{% /staticref %}}.
