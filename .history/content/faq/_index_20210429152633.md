...
<details>
  ...
  You can get the SBOL logo {{% staticref "media\Logos\SBOLlogo.png" "newtab" %}}PNG image file{{% /staticref %}} or {{% staticref "static\media\Logos\SBOLlogo.svg" "newtab" %}}SVG image file{{% /staticref %}}.
