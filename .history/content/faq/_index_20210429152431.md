...
<details>
  ...
  You can get the SBOL logo {{% staticref "static\media\Logos\SBOLlogo.png" "newtab" %}}PNG image file{{% /staticref %}} or {{% staticref "static\media\Logos\SBOLlogo.svg" "newtab" %}}SVG image file{{% /staticref %}}.

  You can get the SBOL Visual logo {{% staticref "static\media\Logos\SBOLVisualLogo.png" "newtab" %}}PNG image file{{% /staticref %}} or {{% staticref "static\media\Logos\SBOLVisualLogo.svg" "newtab" %}}SVG image file{{% /staticref %}}.

  You can get the SBOL Industrial Consortium logo {{% staticref "static\media\Logos\SBOLIndustrialLogo.png" "newtab" %}}PNG image file{{% /staticref %}} or {{% staticref "static\media\Logos\SBOLIndustrialLogo.svg" "newtab" %}}SVG image file{{% /staticref %}}.
