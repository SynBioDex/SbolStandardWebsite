...
benefits:
  ...
  - icon: "fas fa-code"
    ...
    description: "Official implementations in Python, Java, Rust, JavaScript, C++, and more - pick the one that fits your stack."
  - icon: "fas fa-plug"
...
libraries_description: "The SBOL community maintains official libraries across multiple languages. Whether you are working in Python, Java, Rust, JavaScript, C++, or F#, there is a library ready for your stack. All libraries implement the SBOL Core data model and are open-source."
...
toolchain_links:
  ...
  - label: "Rust SDK & CLI"
    description: "Build, validate, and convert SBOL 2 and SBOL 3 in Rust"
    icon: "fab fa-rust"
