...
SBOL has a come a long way! As our community has grown, so has our specification and data model! 



Here are the quick links to the latest specifications: 
* SBOL - [Version 3.0.0](/docs/SBOL3.0specification.pdf)
